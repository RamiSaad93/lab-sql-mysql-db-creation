...
-- Table `car`.`stores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `car`.`stores` (
...
-- -----------------------------------------------------
-- Table `car`.`sales_person`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `car`.`sales_person` (
  ...
  CONSTRAINT `fk_sales_person_stores1`
    ...
    REFERENCES `car`.`stores` (`store_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `car`.`invoices` (
  ...
  CONSTRAINT `fk_invoices_sales_person1`
    ...
    REFERENCES `car`.`sales_person` (`staff_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_invoices_customers1`
    FOREIGN KEY (`customers_customer_id`)
    REFERENCES `car`.`customers` (`customer_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `car`.`cars` (
  ...
  CONSTRAINT `fk_cars_invoices`
    ...
    REFERENCES `car`.`invoices` (`invoice_number`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `car`.`customers_has_sales_person`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `car`.`customers_has_sales_person` (
  `customers_customer_id` INT NOT NULL,
  `sales_person_staff_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `car`.`customers_has_stores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `car`.`customers_has_stores` (
  `customers_customer_id` INT NOT NULL,
  `stores_store_id` INT NOT NULL,
